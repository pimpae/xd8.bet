function lang_th() {
    ...
    $('.lang3').text("เกมโต๊ะ");   
    $('.lang4').text("กีฬา");   
    $('.lang5').text("โปรโมชั่น");     
    $('.lang6').text("ล็อคอิน");   
    $('.lang7').text("สมัครสมาชิก");  
    $('.lang8').text("เกมโชว์");   
    $('.lang9').text("สล็อตยอดนิยม");  
    $('.lang10').text("ผู้ให้บริการเกม");   
    $('.lang11').text("การสนับสนุนทางออนไลน์");  
    $('.lang12').text("ข้อกำหนดและเงื่อนไข");  
...
function lang_en() { 
    $('.lang1').text("ONLINE SLOTS");   
    $('.lang2').text("LIVE CASINO");   
    $('.lang3').text("TABLE GAMES");   
    $('.lang4').text("SPORT");   
    $('.lang5').text("PROMOTIONS");   
    $('.lang6').text("SIGN IN");   
    $('.lang7').text("JOIN NOW");   
    $('.lang8').text("GAMES SHOWS");   
    $('.lang9').text("POPULAR SLOTS");   
    $('.lang10').text("GAME PROVIDERS");   
    $('.lang11').text("Online Support");  
    $('.lang12').text("Terms and Conditions");  
